...
<template>
  <DefaultLayout :current_user="current_user">
    <div>
      <div
        class="rounded-md shadow flex items-center gap-x-6 bg-gray-800 px-6 py-2.5 sm:px-3.5 mb-8"
      >
        ...
        <div class="md:flex md:items-center md:justify-between">
          <div>
            ...
            <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-400">
              To learn more about the world, click the
              <em>load facts</em> button.
            </p>
          </div>
      ...
      <div v-if="facts" class="mt-6 border-t border-gray-700">
